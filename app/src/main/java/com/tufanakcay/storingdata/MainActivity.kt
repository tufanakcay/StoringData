package com.tufanakcay.storingdata
...
import com.tufanakcay.storingdata.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sharedPreferences = this.getSharedPreferences("com.tufanakcay.storingdata",
